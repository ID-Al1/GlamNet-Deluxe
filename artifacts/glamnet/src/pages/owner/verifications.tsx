...
import { ShieldCheck, ShieldX, Mail, Phone, MapPin, Clock, Inbox, FileText, AlertCircle, RefreshCw } from "lucide-react";
...
export default function OwnerVerifications() {
  ...
  if (forbidden) {
    return (
      <div className="max-w-2xl mx-auto px-5 py-16 text-center">
        <ShieldX className="h-10 w-10 mx-auto mb-4 text-muted-foreground" strokeWidth={1.9} />
  ...
  return (
    <div className="max-w-3xl mx-auto w-full">
      ...
      {loadError && (
        <Card className="bg-card border-border/50">
          <CardContent className="py-14 text-center">
            <AlertCircle className="h-9 w-9 mx-auto mb-4 text-destructive" strokeWidth={1.9} />
            <p className="font-medium mb-1">Verification queue unavailable</p>
            <p className="text-sm text-muted-foreground mb-5">{loadError}</p>
            <Button variant="outline" onClick={() => void load()} data-testid="button-retry-verification-queue">
      ...
      {artists !== null && !loadError && artists.length === 0 && (
        <Card className="bg-card border-border/50">
          <CardContent className="py-14 text-center">
            <Inbox className="h-9 w-9 mx-auto mb-4 text-muted-foreground/50" strokeWidth={1.9} />
