// AuthContext lives in ./auth-context.ts — a file with no runtime dependency
// on @workspace/api-client-react — so it is never recreated during codegen HMR.
// See auth-context.ts for a full explanation.
